...
public class Car extends LandVehicles{
	...
	public Car(int id, int year, int price, int weight, int mileage, String brand, String model, Color color, Engine engine, Transmission transmission, ImageIcon photo) {
	this.id = id;
	this.year = year;
	this.price = price;
	this.weight = weight;
	...
	// Copying constructor:
	public Car(Car car) {
		this(car.id, car.year, car.price, car.weight, car.mileage, car.brand, car.model, car.color, car.engine, car.transmission, car.photo);
	}
