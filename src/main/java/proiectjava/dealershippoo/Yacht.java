...
public class Yacht extends WaterVehicles{
    ...
    Yacht(int id,String brand,String model,int year,Color color,int price,int weight,int nauticalMiles,Engine engine,ImageIcon photo){
        //trans needed
        this.id=id;
        this.brand=brand;
        this.model=model;
    ...
    public String toString() {
        return "Yacht{" + "id=" + id + ", brand=" + brand + ", model=" + model + ", year=" + year + ", color=" + color + ", price=" + price + ", weight=" + weight + ", nauticalMiles=" + nauticalMiles + ", engine=" + engine + ", photo=" + photo + '}';
    }
